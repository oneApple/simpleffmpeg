...
OBJS        = $(addsuffix .o,          $(PROGS-yes)) cmdutils.o src/GetYVector.o
...
%_g$(EXESUF): %.o cmdutils.o src/GetYVector.o $(FF_DEP_LIBS)
	$(LD) $(FF_LDFLAGS) -o $@ $< cmdutils.o src/GetYVector.o $(FF_EXTRALIBS)
#LD=gcc
...
.PHONY: *test regtest-* alltools check config #documentation
